...
class FundedPage extends StatefulWidget{
  List<Data> newListingList = <Data>[];
  var type = "";


  FundedPage({super.key,required this.newListingList,required this.type});


  @override
  State<FundedPage> createState() => _FundedListingPage(newListingList,type);
}
...
class _FundedListingPage extends State<FundedPage> with SingleTickerProviderStateMixin{
  List<Data> newListingList = <Data>[];

  var type="";
  _FundedListingPage(this.newListingList,this.type);
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(onPressed:(){
              propertiesApi();
              Navigator.of(context).pop(); }, child: Text('Search')),
            TextButton(onPressed:(){
