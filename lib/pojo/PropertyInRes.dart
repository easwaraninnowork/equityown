class PropertyInRes {
  ...
  PropertyInRes({this.result});

  PropertyInRes.fromJson(Map<String, dynamic> json) {
    result =
...
class Result {
  ...
  dynamic? stateId;
  int? bookmark;
  int? currentUserInvested;
  int? pendingAmountForPayment;
  dynamic? fundedPercentage;
  ...
  Result(
      {this.id,
        ...
        this.stateId,
        this.bookmark,
        this.currentUserInvested,
        this.pendingAmountForPayment,
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    currentUserInvested = json['current_user_invested'];
    pendingAmountForPayment = json['pending_amount_for_payment'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['current_user_invested'] = this.currentUserInvested;
    data['pending_amount_for_payment'] = this.pendingAmountForPayment;
  ...
  SimilarProperties.fromJson(Map<String, dynamic> json) {
    ...
    if (json['milestones'] != null) {
      ...
      json['milestones'].forEach((v) {
        milestones!.add(new Documents.fromJson(v));
      });
    }
    if (json['funding_log'] != null) {
      fundingLog = <FundingLog>[];
